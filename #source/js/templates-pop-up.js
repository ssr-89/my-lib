...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  /*tabs*/
  const tabsMainItems = document.querySelector('.code-pop-up-items');
  ...
  for (let index = 0; index < tabsItems.length; index++) {
    if (tabsItems[index].classList.contains('open-tabs-item')) {
      const tabsItemsChild = tabsItems[index].querySelector('.code-pop-up-item__pre');
      const tabsItemsChildHeight = tabsItemsChild.getBoundingClientRect().height;
      tabsMainItems.style.minHeight = tabsItemsChildHeight + "px";
    }
  }
  ...
  tabsBtns.forEach(function(tabsBtn){
    tabsBtn.addEventListener('click', (tabsBtn)=>{
      ...
      const tabsOpenItemsChild = tabsOpenItem.querySelector('.code-pop-up-item__pre');
      const tabsOpenItemsChildHeight = tabsOpenItemsChild.getBoundingClientRect().height;
      tabsMainItems.style.minHeight = tabsOpenItemsChildHeight + "px";
    });
  });
});